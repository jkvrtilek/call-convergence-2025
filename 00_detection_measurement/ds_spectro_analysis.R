...
# read in data
extSelTable <- readRDS(paste("/fs/ess/scratch/PAS1986/downExtSelTables/", args[1], sep = ""))
...
saveRDS(specan, file = paste("/fs/ess/scratch/PAS1986/downSpecan/spectro_analysis_", args[1], sep = ""))