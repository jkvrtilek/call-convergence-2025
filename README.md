...
Data for "Vocal convergence during formation of cooperative relationships in vampire bats". figshare. Dataset. https://doi.org/10.6084/m9.figshare.29191334
...
1. 01_get_acoustic_measuresXX.R
	...
	- *Input data available on Figshare.* https://doi.org/10.6084/m9.figshare.29191334
	...
	- *Product available on Figshare.* https://doi.org/10.6084/m9.figshare.29191334
...
3. 03_get_vocal_distancesXX.R
    ...
    - *Product: vocal-distance-95-bats.csv*  

4. 04_combine_vocal_social_dataXX.R

    - Combines vocal data generated in 03_get_vocal_distancesXX.R with social data (available on Figshare).
...
2. 03_get_vocal_distances
    ...
    - DFA loadings sorted by absolute value of LD1 (dfa-loadings-95-bats.csv)
...
1. Generated by 03_get_vocal_distancesXX.R
    ...
    - CSV of vocal distance matrix (vocal-distance-95-bats.csv)  
...
2. Used in 04_combine_vocal_social_dataXX.R
    ...
    - CSV of sexes and (known) ages of bats (sex_age03.csv)  
